...
const letter = [
  ...
  "遇见你以后，我才发现喜欢一个人不是突然变得会说很多漂亮话，而是每一件小事都会先想到你。看到好看的云会想拍给你，听到好听的歌会想分享给你，连很普通的一天，只要和你有关，就会变得特别。",
  "我喜欢你笑起来的样子，喜欢你认真说话的样子，也喜欢你偶尔撒娇、偶尔小脾气的样子。因为那都是魏雨娜，是我心里独一份的可爱。",
  ...
  "如果未来有很多不确定，那我确定的一件事就是：叶子箫会一直站在魏雨娜这边。偏爱你，保护你，认真听你说话，也把你稳稳放在心上。",
  "我不敢说自己每一件事都能做到完美，但我会一直学着更懂你、更珍惜你、更好地爱你。因为你值得很多很多温柔，也值得被坚定地选择。",
  "520快乐，我的魏雨娜。今天的喜欢是你，明天的想念是你，以后很长很长的日子，我的答案也还是你。",
  "叶子箫真的很爱你。"
].join("\n\n");
